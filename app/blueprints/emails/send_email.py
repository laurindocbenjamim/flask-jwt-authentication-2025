...
from app.blueprints.emails.send_confirmation_email_sendgrid_api import SendConfirmationEmailSendGridApi
# Application Configuration

send_email_api = Blueprint("send_email", __name__, url_prefix='/api/v1/email')
api = Api(send_email_api)

api.add_resource(SendConfirmationEmailSendGridApi, '/send-confirm')
