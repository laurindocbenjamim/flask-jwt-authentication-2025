    ...
    def post(self):
        ...
        try:
            ...
            if uploaded_audio_file and uploaded_audio_file.filename != '':
                ...
                uploaded_audio_path = os.path.join(UPLOAD_FOLDER, f"{uuid.uuid4()}_{uploaded_audio_filename}")
            ...
            if recorded_audio_file and recorded_audio_file.filename != '':
                ...
                recorded_audio_path = os.path.join(UPLOAD_FOLDER, f"{uuid.uuid4()}_{recorded_audio_filename}")
            ...
            temp_audio_filepath = os.path.join(UPLOAD_FOLDER, temp_audio_filename)
